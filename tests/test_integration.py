...
class TestIntegration(unittest.TestCase):
    ...
    def test_end_to_end_profiling(self):
        ...
        # Profile a block
        profile = profile_block_in_scaffold("blockzoo.scaffold.IdentityBlock", position="early")
    ...
    def test_multiple_positions(self):
        ...
        for position in positions:
            profile = profile_block_in_scaffold("blockzoo.scaffold.IdentityBlock", position=position)
